                ...
                <form className='Auth-form' onSubmit={e => validate(e)}>
                    <div className='Auth-form-content'>
                        ...
                        <div className='form-group mt-3'>
                            <input className='form-control mt-1 input' type="text" id="ownerEmail" placeholder='Retailer Name' onChange={(e) => setOwEmail(e) }/>
                        </div>
                        <div className='form-group mt-3'>
                            <input className='form-control mt-1 input' type="text" id="ownerEmail" placeholder='Email' onChange={(e) => setOwEmail(e) }/>
                        </div>
                        <div className='form-group mt-3'>
                            <input className='form-control mt-1 input' type="password" id="ownerPassword" autoComplete="on" placeholder='Password' onChange={(e) => setPass(e) }/>
                        </div>
                        
                        <div className='form-group mt-3'>
                            <input className='form-control mt-1 input' type="text" id="ownerEmail" placeholder='Phone' onChange={(e) => setOwEmail(e) }/>
                        </div>
                        <div className='form-group mt-3'>
                            <input className='form-control mt-1 input' type="text" id="ownerEmail" placeholder='Address' onChange={(e) => setOwEmail(e) }/>
                        </div>
                        <div className='form-group mt-3'>
                            <input className='form-control mt-1 input' type="text" id="ownerEmail" placeholder='Pincode' onChange={(e) => setOwEmail(e) }/>
                        </div>
